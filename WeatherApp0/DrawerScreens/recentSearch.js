...
import { Button, View,Text,StyleSheet,ImageBackground,FlatList,Image,TouchableOpacity} from 'react-native';
...
function RecentsScreen({ navigation }) {
  ...
  const dispatchDeleteAll = Items=>{
    dispatch(deleteAllRecSearch(Items));
  };
  const openSearch = () => {
  ...
  const renderEmptyPage = () => {
      return (
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>No Recently searched items</Text>
        </View>
      );
  };
